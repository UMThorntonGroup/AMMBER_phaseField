...
public:
  ...
  std::string 
  get_model_constant_string(const std::string constant_name) const
  {
  ...
  std::vector<double>
  get_model_constant_double_array(const std::string constant_name) const
  {
    return boost::get<std::vector<double>>(
      model_constants[model_constant_name_map.at(constant_name)]);
  };

	std::vector<int>
	get_model_constant_int_array(const std::string constant_name) const
	{
	  return boost::get<std::vector<int>>(
	    model_constants[model_constant_name_map.at(constant_name)]);
	};

	std::vector<bool>
	get_model_constant_bool_array(const std::string constant_name) const
	{
	  return boost::get<std::vector<bool>>(
	    model_constants[model_constant_name_map.at(constant_name)]);
	};
	
	std::vector<std::string>
	get_model_constant_string_array(const std::string constant_name) const
	{
	  return boost::get<std::vector<std::string>>(
	    model_constants[model_constant_name_map.at(constant_name)]);
	};
